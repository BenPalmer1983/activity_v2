...
def load_symbols(file_name):
  ...
  for line in fh:
    ...
    try:
      ...
      symbols[protons] = symbol
      symbols[symbol] = protons
    except:
      pass
...
def load_isotopes(elements, file_name):
...
def load_decaymodes(elements, file_name):
  fh = open(file_name, 'r')
  for line in fh:
    fields = line.split(" ")
    ...
    try:
      ...
      elements[protons]['isotopes'][nucleons]['decay_modes'].append({
